...
- Linux/Tauri packaging is validated for the Rust production sidecar, including
  ...
  GitHub Actions validates unsigned Windows/Linux package builds. Signed
  Windows/Tauri release packaging has not been validated.
