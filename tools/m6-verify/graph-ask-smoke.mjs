...
try {
  ...
  const assertions = [
    ...
    ["orientation answer is graph-only", orientationAnswer.text.includes("Codebase overview from the dependency graph.")],
    ...
    ["codebase overview answer is graph-only", codebaseOverviewAnswer.text.includes("Codebase overview from the dependency graph.")],
